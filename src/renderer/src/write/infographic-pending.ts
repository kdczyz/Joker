 ...
 * `Joker-pending-infographic:` scheme, so the document itself carries the
...
export const PENDING_INFOGRAPHIC_PROTOCOL = 'Joker-pending-infographic:'

const PENDING_SRC_PATTERN = /^Joker-pending-infographic:\/\/([A-Za-z0-9-]+)$/
...
/** Parse `![alt](Joker-pending-infographic://id)` image markdown. */
