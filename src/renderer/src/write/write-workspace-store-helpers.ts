...
export const WRITE_PREVIEW_MODE_KEY = 'Joker.write.preview-mode'
export const WRITE_ASSISTANT_OPEN_KEY = 'Joker.write.assistant-open'
export const WRITE_ASSISTANT_MODEL_KEY = 'Joker.write.assistant-model'
export const WRITE_ASSISTANT_PROVIDER_KEY = 'Joker.write.assistant-provider'
const DEFAULT_WRITE_ASSISTANT_MODEL = DEFAULT_JOKER_MODEL
...
export function activeFileStorageKey(workspaceRoot: string): string {
  return `Joker.write.active-file:${normalizePath(workspaceRoot)}`
}
