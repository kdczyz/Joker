...
export type CoreRuntimeCapabilityManifestJson = {
  ...
  /** Optional so the GUI keeps working against older Joker builds without the capability. */
 ...
 * `create_plan` tool result. Mirrors the Joker output contract
 ...
 * reserved plan id, workspace root, and relative path the Joker
...
/**
 * Native Joker plan tool name. Re-exported alongside the shared
