...
export type CoreRuntimeCapabilityManifestJson = {
  ...
  /** Optional so the GUI keeps working against older Rcode builds without the capability. */
 ...
 * `create_plan` tool result. Mirrors the Rcode output contract
 ...
 * reserved plan id, workspace root, and relative path the Rcode
...
/**
 * Native Rcode plan tool name. Re-exported alongside the shared
