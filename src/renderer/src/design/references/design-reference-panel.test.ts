...
describe('buildDesignReferencePanelModel', () => {
  it('summarizes canvas images, screen artifacts, notes, and selected references', () => {
    ...
    const hero = addShape(doc, {
      ...
      width: 320,
      height: 180,
      imageUrl: '.Rcode-design/assets/hero.png'
    }, moodboard.id)
    addShape(doc, {
    ...
    expect(model.action.prompt).toContain('.Rcode-design/assets/hero.png')
    expect(model.action.prompt).toContain('.Rcode-design/doc/home/DESIGN.md')
  })
