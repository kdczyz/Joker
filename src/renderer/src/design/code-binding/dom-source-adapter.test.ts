  ...
  it('keeps untouched bindings active outside the requested sync scope', () => {
    const existing: DesignCodeBinding[] = [
      {
        ...
        status: 'active',
        createdAt: '2026-07-01T00:00:00.000Z',
        target: { sourceFile: '.Joker-design/home.html', domId: 'home' }
      },
      {
        ...
        status: 'active',
        createdAt: '2026-07-01T00:00:00.000Z',
        target: { sourceFile: '.Joker-design/settings.html', domId: 'settings' }
      }
    ]
    ...
    const bindings = bindingsFromDomSourceSnapshot({
      ...
      matches: [
        {
          designObjectId: 'frame_1',
          node: { tagName: 'main', sourceFile: '.Joker-design/home.html', domId: 'home-v2' }
        }
      ]
    })
