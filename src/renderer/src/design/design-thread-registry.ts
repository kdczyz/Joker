...
const DESIGN_THREAD_REGISTRY_KEY = 'Rcode.design.threadRegistry.v1'
const LEGACY_DESIGN_ASSISTANT_THREAD_REGISTRY_KEY = 'Rcode.design-assistant.threadRegistry.v1'
