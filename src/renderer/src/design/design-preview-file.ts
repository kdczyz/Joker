...
const SKELETON_MARKER = 'Joker is preparing a live preview'
...
<body>
  <main aria-live="polite">
    ...
    <p>Joker is preparing a live preview for <code>${safePath}</code>. The canvas will refresh as the HTML file changes.</p>
  </main>
</body>
</html>
`
