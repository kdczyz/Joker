...
const SKELETON_MARKER = 'Rcode is preparing a live preview'
...
<body>
  <main aria-live="polite">
    ...
    <p>Rcode is preparing a live preview for <code>${safePath}</code>. The canvas will refresh as the HTML file changes.</p>
  </main>
</body>
</html>
`
