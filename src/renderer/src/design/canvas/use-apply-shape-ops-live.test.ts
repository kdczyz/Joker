...
describe('durable SVG create replay', () => {
  ...
  const baseArtifact = {
    ...
    kind: 'svg' as const,
    title: 'Orbit',
    relativePath: '.Joker-design/doc/svg-aabbccddeeff/v1.svg',
  ...
  it('extracts the newest generated image file from generate_image tool blocks', () => {
    const blocks: ChatBlock[] = [
      ...
      },
      {
        ...
        status: 'success',
        meta: {
          toolName: 'mcp__Joker__generate_image',
    ...
    const blocks: ChatBlock[] = [
      {
        ...
        meta: {
          ...
          generatedFiles: [{
            ...
            absolutePath: '/Users/zxy/.Joker/default_workspace/.deepseekgui-images/new.png'
          }]
        }
      }
    ]

    expect(latestGeneratedImageUrlForTurn(blocks)).toBe('/Users/zxy/.Joker/default_workspace/.deepseekgui-images/new.png')
    expect(
      rewriteGeneratedImageUrlsForTurn(
        {
      ...
      ops: [{
        op: 'update',
        id: 'shape-1',
        patch: { imageUrl: '/Users/zxy/.Joker/default_workspace/.deepseekgui-images/new.png' }
      }]
    })
  })
