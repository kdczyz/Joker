...
function installLinkedScreenFactory(): void {
  const board: DesignArtifact = {
    ...
    createdAt,
    updatedAt: createdAt,
    versions: [{ id: 'board-v1', relativePath: '.Joker-design/doc/board/canvas.json', createdAt, summary: '' }]
  }
  const doc: DesignDocument = {
    id: 'doc',
    title: 'Doc',
    ...
    const result = executeOps([
      {
        ...
        shape: {
          ...
          width: 430,
          height: 430,
          imageUrl: '.deepseekgui-images/sample-logo.png'
        }
      }
    ])
...
describe('add-screens', () => {
  ...
  it('keeps new linked screen titles unique against hidden HTML artifacts', () => {
    ...
    const hidden: DesignArtifact = {
      ...
      kind: 'html',
      title: 'Home',
      relativePath: '.Joker-design/doc/hidden-home/v1.html',
      createdAt,
      updatedAt: createdAt,
      versions: [{ id: 'hidden-home-v1', relativePath: '.Joker-design/doc/hidden-home/v1.html', createdAt, summary: '' }],
