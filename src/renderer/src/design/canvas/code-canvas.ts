...
/** Workspace subdir for code-mode canvases. Kept out of `.Joker-design` so design
 * mode's artifact lister (which enumerates `.Joker-design/*`) never sees them. */
export const CODE_CANVAS_DIR = '.Joker-canvas'
