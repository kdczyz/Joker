...
describe("design turn prompt HTML, screen, and canvas guidance", () => {
    it('builds a parallel page fanout prompt with one delegate_task per artifact', () => {
      const prompt = buildParallelDesignPagesPrompt({
        ...
        projectBrief: 'IJOKER community site',
        jobs: [
          {
            artifactId: 'landing',
            title: 'Landing',
            relativePath: '.Joker-design/doc/landing/v1.html',
            designMdPath: '.Joker-design/doc/landing/DESIGN.md',
          ...
          },
          {
            ...
            title: 'Community',
            relativePath: '.Joker-design/doc/community/v1.html',
            designMdPath: '.Joker-design/doc/community/DESIGN.md',
            brief: 'Community feed and member stories',
            screenManifest: [{ name: 'Design system', htmlPath: '.Joker-design/doc/system/v1.html', role: 'design-system' }]
          }
        ]
      })
      ...
      expect(prompt).toContain('Modify ONLY `.Joker-design/doc/landing/v1.html` and `.Joker-design/doc/landing/DESIGN.md`')
      expect(prompt).toContain('Modify ONLY `.Joker-design/doc/community/v1.html` and `.Joker-design/doc/community/DESIGN.md`')
        ...
        jobs: [
          {
            artifactId: 'home',
            title: 'Today',
            relativePath: '.Joker-design/doc/today/v1.html',
            designMdPath: '.Joker-design/doc/today/DESIGN.md',
    ...
    it('allows only the reserved HTML and companion design notes files for HTML turns', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        artifactRelativePath: '.Joker-design/screen/v1.html',
        designNotesPath: '.Joker-design/screen/DESIGN.md',
        workspaceRoot: '/workspace'
      })
  
      expect(prompt).toContain('Design notes file: .Joker-design/screen/DESIGN.md')
      expect(prompt).toContain('Design target: Web')
      expect(prompt).toContain('1280x800 desktop web')
      expect(prompt).toContain(
        'Modify ONLY `.Joker-design/screen/v1.html` and `.Joker-design/screen/DESIGN.md`'
      )
    ...
    it('biases screen prompts toward mobile app frames when the design target is app', () => {
      const options: ScreenTurnOptions = {
        ...
        artifactRelativePath: '.Joker-design/habit/v1.html',
        workspaceRoot: '/workspace',
    ...
    it('passes selected screen frame details and notes file for screen turns', () => {
      const options: ScreenTurnOptions = {
        ...
        artifactRelativePath: '.Joker-design/screen/v2.html',
        designNotesPath: '.Joker-design/screen/DESIGN.md',
        basePath: '.Joker-design/screen/v1.html',
        workspaceRoot: '/workspace',
        screenName: 'Login',
        screenWidth: 420,
        screenHeight: 340,
        ...
        screenManifest: [
          {
            ...
            width: 1280,
            height: 720,
            htmlPath: '.Joker-design/home/v1.html'
          }
        ]
      }
      const prompt = buildDesignTurnPrompt(options)
      ...
      expect(prompt).toContain('Design notes file: .Joker-design/screen/DESIGN.md')
      expect(prompt).toContain('Modify ONLY `.Joker-design/screen/v2.html` and `.Joker-design/screen/DESIGN.md`')
      ...
      expect(prompt).toContain('.Joker-design/home/v1.html')
    })
    it('injects real frame dimensions into HTML iteration prompts', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        artifactRelativePath: '.Joker-design/system/v2.html',
        designNotesPath: '.Joker-design/system/DESIGN.md',
        basePath: '.Joker-design/system/v1.html',
        workspaceRoot: '/workspace',
        frameContext: {
          name: 'Design system',
          width: 1330,
    ...
    it('includes sibling pages so HTML turns stay cohesive across the canvas', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        artifactRelativePath: '.Joker-design/settings/v1.html',
        workspaceRoot: '/workspace',
        screenManifest: [
          { name: 'Home', htmlPath: '.Joker-design/home/v1.html', summary: 'Landing page' },
          { name: 'Chat', width: 420, height: 720, htmlPath: '.Joker-design/chat/v1.html' }
        ]
      })
  
      expect(prompt).toContain('Other pages already in this project')
      expect(prompt).toContain('"Home" → .Joker-design/home/v1.html (prototype href: ../home/v1.html) — Landing page')
      expect(prompt).toContain('"Chat" (420x720) → .Joker-design/chat/v1.html (prototype href: ../chat/v1.html)')
    ...
    it('computes local prototype hrefs between generated HTML artifacts', () => {
      expect(buildPrototypeHref('.Joker-design/doc/settings/v1.html', '.Joker-design/doc/home/v1.html')).toBe('../home/v1.html')
      expect(buildPrototypeHref('.Joker-design/doc/a/b/v1.html', '.Joker-design/doc/c/v1.html')).toBe('../../c/v1.html')
      expect(buildPrototypeHref(undefined, '.Joker-design/doc/home/v1.html')).toBe('.Joker-design/doc/home/v1.html')
    })
    ...
    it('adds iteration edit discipline for existing screen edits without requiring an element selection', () => {
      const options: ScreenTurnOptions = {
        ...
        artifactRelativePath: '.Joker-design/pricing/v2.html',
        basePath: '.Joker-design/pricing/v1.html',
        workspaceRoot: '/workspace',
        screenName: 'Pricing',
        screenManifest: []
      }
    ...
    it('tells the agent the path + directory of selected design artifacts (no inlined content)', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        artifactRelativePath: '.Joker-design/board/settings/v1.html',
        workspaceRoot: '/workspace',
        contextLocations: [
          {
            title: 'Settings',
            kind: 'html',
            path: '.Joker-design/board/settings/v1.html',
            directory: '.Joker-design/board/settings'
          },
          {
            title: 'Hero',
            kind: 'image',
      ...
      expect(prompt).toContain('Settings [html] → `.Joker-design/board/settings/v1.html` (directory: `.Joker-design/board/settings`)')
    ...
    it('renders per-sibling accent + font + summary in the screen manifest', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        artifactRelativePath: '.Joker-design/doc/p/v1.html',
        workspaceRoot: '/ws',
        screenManifest: [
          {
            name: 'Home',
