...
import type { CoreRuntimeInfoJson, CoreRuntimeSkillJson } from '../../agent/Joker-contract'
...
async function loadSkillCommands(
  ...
  const localSkillsTask = typeof window !== 'undefined' && typeof window.JokerGui?.listSkills === 'function'
    ? window.JokerGui.listSkills(activeSkillWorkspace || undefined)
