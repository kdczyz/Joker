...
export const PINNED_FILE_PREVIEW_TARGETS_KEY = 'Joker.filePreview.pinnedTargets'
export const PRESERVE_FILE_PREVIEW_TARGETS_KEY = 'Joker.filePreview.preserveAcrossThreads'
export const LEGACY_PINNED_FILE_PREVIEW_TARGETS_KEY = 'Joker.issue781.pinnedPreviewTabs'
...
export function useWorkbenchFileTreeController({
  ...
  async function pickComposerFileReferences(): Promise<void> {
    const result = await window.JokerGui.pickLocalFiles(activeSkillWorkspace || undefined)
