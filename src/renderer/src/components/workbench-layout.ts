...
const LEFT_PANEL_WIDTH_KEY = 'Joker.layout.leftSidebarWidth'
const LEFT_PANEL_COLLAPSED_KEY = 'Joker.layout.leftSidebarCollapsed'
const RIGHT_PANEL_WIDTH_KEY = 'Joker.layout.rightInspectorWidth'
