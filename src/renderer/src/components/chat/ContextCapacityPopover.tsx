...
export function ContextCapacityPopover({ capacity, thresholdRatio = 0.9, style }: Props): ReactElement {
  ...
  return (
    <div
      className="ds-context-capacity w-[300px] max-w-[calc(100vw-1.5rem)] rounded-2xl border border-ds-border-muted bg-ds-card dark:bg-[#212322] p-3.5 text-ds-ink shadow-[0_14px_34px_rgba(20,47,95,0.16)]"
      style={style}
      role="dialog"
