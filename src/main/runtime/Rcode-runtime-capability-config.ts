import type { RcodeRuntimeSettingsV1 } from '../../shared/app-settings'
import { resolveCodexOAuthApiKey } from '../codex-auth'

export function computerUseConfigForRuntime(
  value: Pick<RcodeRuntimeSettingsV1, 'computerUse'>['computerUse'],
...
export function imageGenConfigForRuntime(
  value: Pick<RcodeRuntimeSettingsV1, 'imageGeneration'>['imageGeneration'],
  existing: Record<string, unknown>
): Record<string, unknown> {
...
export function speechGenConfigForRuntime(
  value: Pick<RcodeRuntimeSettingsV1, 'textToSpeech'>['textToSpeech'],
  existing: Record<string, unknown>
): Record<string, unknown> {
  const next: Record<string, unknown> = {
    ...existing,
...
export function musicGenConfigForRuntime(
  value: Pick<RcodeRuntimeSettingsV1, 'musicGeneration'>['musicGeneration'],
  existing: Record<string, unknown>
): Record<string, unknown> {
  const next: Record<string, unknown> = {
    ...existing,
...
export function videoGenConfigForRuntime(
  value: Pick<RcodeRuntimeSettingsV1, 'videoGeneration'>['videoGeneration'],
  existing: Record<string, unknown>
): Record<string, unknown> {
  const next: Record<string, unknown> = {
    ...existing,
...
export function runtimeTuningConfigForRuntime(
  value: Pick<RcodeRuntimeSettingsV1, 'runtimeTuning'>['runtimeTuning'],
  existing: Record<string, unknown>
): Record<string, unknown> {
  return {
    ...existing,
...
export function qualityConfigForRuntime(
  value: Pick<RcodeRuntimeSettingsV1, 'quality'>['quality'],
  existing: Record<string, unknown>
): Record<string, unknown> {
  return {
    ...existing,
