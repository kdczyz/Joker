...
export type JokerUnexpectedExitInfo = {
  code: number | null
...
/**
 * Owns the mutable lifecycle state for the one GUI-managed Joker child.
 *
 ...
 */
export class JokerProcessController<LogCapture> {
  ...
  private unexpectedExitHandler: ((info: JokerUnexpectedExitInfo) => void) | null = null
  ...
  reportUnexpectedExit(info: JokerUnexpectedExitInfo): void {
