...
export type RcodeUnexpectedExitInfo = {
  code: number | null
...
/**
 * Owns the mutable lifecycle state for the one GUI-managed Rcode child.
 *
 ...
 */
export class RcodeProcessController<LogCapture> {
  ...
  private unexpectedExitHandler: ((info: RcodeUnexpectedExitInfo) => void) | null = null
  ...
  reportUnexpectedExit(info: RcodeUnexpectedExitInfo): void {
