...
/**
 * 把“DeepSeek GUI”时代遗留的会话目录导入到当前 Joker 数据目录。
 *
 * 关键事实(决定了实现方式):
...
export type LegacySessionSourceCandidate = {
  ...
  /** 旧版线程目录的绝对路径,如 ~/.deepseekgui/Joker/threads。 */
  path: string
}
 ...
 * 也支持选中它的上级(如 .../Joker),自动下探一层 threads。
 */
