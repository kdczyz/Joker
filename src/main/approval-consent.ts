...
export const JOKER_APPROVAL_CONSENT_HEADER = 'x-Joker-approval-consent'
...
export function createApprovalConsentToken(input: {
  ...
  if (!input.runtimeToken) throw new Error('Joker runtime token is required for protected approval.')
