...
export class ExtensionMediaProcessService {
  ...
  async audioAnalysisCapabilities(
    ...
    return {
      ...
      // produced by Rcode's deterministic bounded onset/autocorrelation
   ...
   * bounds only; executable arguments and the resolved path stay inside Rcode.
   */
   ...
   * evidence inside Rcode. FFmpeg never chooses the algorithm and extensions
   ...
   * vector. No frame bytes or local locations leave Rcode.
   */
