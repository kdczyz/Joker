...
function safeProvenanceMetadata(
  ...
  if (value.interchangeAdapterId === 'Rcode.otio-json') {
  ...
  if (typeof value.RcodeRoundTripLossless === 'boolean') metadata.RcodeRoundTripLossless = value.RcodeRoundTripLossless
