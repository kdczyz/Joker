 ...
 */
export const DESIGN_MODE_INSTRUCTION = `You are operating Rcode Design mode. Infer the user's intended design outcome before choosing tools; do not force every request through the same workflow.
 ...
 */
export const SVG_ARTIFACT_MODE_INSTRUCTION = `You are operating a dedicated Rcode SVG artifact turn for one already-reserved file.
