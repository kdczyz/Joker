...
const report = await runReplaySuite(suite, {
  ...
  token: process.env.RCODE_RUNTIME_TOKEN,
...
function parseArgs(args: string[]): CliOptions {
  const options: CliOptions = {
    baseUrl: process.env.RCODE_RUNTIME_URL ?? DEFAULT_RUNTIME_URL,
...
function printUsage(): void {
  console.log('Usage:')
  console.log('  npm --prefix Rcode run benchmark:replay -- --suite <file> [options]')
  console.log('')
  console.log('Options:')
  console.log(`  --base-url <url>          Rcode runtime URL (or RCODE_RUNTIME_URL, default ${DEFAULT_RUNTIME_URL})`)
  ...
  console.log('')
  console.log('Authentication: set RCODE_RUNTIME_TOKEN; it is intentionally not accepted as a CLI flag.')
}
