...
import { RcodeCapabilitiesConfig } from './capabilities.js'
import { HooksConfigSchema } from '../hooks/hook-config.js'

const RuntimeConfigApplyServeConfig = RcodeServeConfigSchema.omit({
  host: true,
  port: true,
  dataDir: true,
  runtimeToken: true,
...
export const RuntimeConfigApplyRequest = z
  .object({
    ...
    capabilities: RcodeCapabilitiesConfig.optional(),
