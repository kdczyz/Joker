/**
 * Rcode-side mirror of the shared GUI plan contract from
 * Rcode's `src/shared/gui-plan.ts`.
 *
 * The renderer and the Rcode package live in the same repo but
 * TypeScript's `rootDir` constraint prevents Rcode from
