 ...
 * draft or refine plan turns. When present, Rcode exposes the
...
export type ToolHostContext = {
  ...
  workspace: string
  /**
   * Thread mode advertised by the GUI. Rcode restricts plan tools
  ...
  /** Rcode runtime data root; used to allow sandbox-safe reads of background shell output files. */
