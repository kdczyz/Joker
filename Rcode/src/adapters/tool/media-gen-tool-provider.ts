...
import type { RcodeCapabilitiesConfig } from '../../contracts/capabilities.js'
...
export function buildSpeechGenToolProviders(
  config: RcodeCapabilitiesConfig['speechGen'] | undefined,
...
export function buildMusicGenToolProviders(
  config: RcodeCapabilitiesConfig['musicGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
...
export function buildVideoGenToolProviders(
  config: RcodeCapabilitiesConfig['videoGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
