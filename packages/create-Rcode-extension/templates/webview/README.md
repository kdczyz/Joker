...
Generated framework-neutral Rcode Webview extension for Extension API 1.x. The
...
browsers cannot resolve npm package specifiers such as `@Rcode/extension-api`.
...
Developer documentation: https://Rcode.dev/extensions/1/
