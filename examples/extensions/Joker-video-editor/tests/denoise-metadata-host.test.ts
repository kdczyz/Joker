...
import { JokerLocalAudioAnalysisBroker } from '../src/host/Joker-audio-analysis-broker.js'
import {
...
const descriptor: DenoiseMetadataAdapterDescriptor = {
  adapterId: 'Joker.fixture.denoise-metadata',
...
describe('Host denoise metadata orchestration', () => {
  it('negotiates the current public Joker Broker honestly unavailable', async () => {
