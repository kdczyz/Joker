import type { Locale } from '@joker-code/extension-api'
...
const EN = {
  ...
  hostAuthorization: 'These checks express intent. Joker Host must still issue a short-lived authorization bound to the exact request, uploads, and cost ceiling.',
...
const ZH = {
  ...
  hostAuthorization: '这些勾选只表达操作意图；Joker Host 仍必须签发与精确请求、上传素材及费用上限绑定的短期授权。',
