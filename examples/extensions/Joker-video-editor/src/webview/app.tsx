import type { GeneratedArtifact, JobSnapshot, MediaCapabilityFeature } from '@joker-code/extension-api'
  ...
  return <Panel title={messages.interchangeTitle}>
    ...
    {preview && <section className="interchange-import-preview" aria-label={messages.interchangeImportPreviewTitle}>
      <div className="interchange-heading">
        ...
        <span className="job-state">{preview.fidelity === 'Joker-metadata'
          ? messages.interchangeFidelityJoker
      ...
      <dl className="interchange-metrics">
        ...
        <div><dt>{messages.interchangeFidelity}</dt><dd>{preview.fidelity === 'Joker-metadata'
          ? messages.interchangeFidelityJoker
...
function LossManifestView({ manifest, messages }: {
  ...
  return <details className="interchange-loss" open={!manifest.portableLossless || !manifest.JokerRoundTripLossless}>
    ...
    <p className={manifest.JokerRoundTripLossless ? 'package-complete' : 'package-incomplete'}>
      {manifest.JokerRoundTripLossless ? messages.interchangeRoundTripLossless : messages.interchangeRoundTripLossy}
    </p>
