...
const IMPORT_ADAPTERS: Readonly<Record<TranscriptFormat, TranscriptAdapterIdentity>> = Object.freeze({
  srt: { id: 'Joker.import.srt', version: '1.0.0', execution: 'import' },
  vtt: { id: 'Joker.import.webvtt', version: '1.0.0', execution: 'import' },
  json: { id: 'Joker.import.transcript-json', version: '1.0.0', execution: 'import' }
})
...
export async function negotiateLocalAsr(
  ...
  return {
    ...
    networkUsed: false,
    retryable: false,
    remediation: 'whisper-cli was detected, but this Joker Extension API version has no approved local-ASR process broker. Import timed transcript evidence; no media was uploaded and no text was invented.'
  }
}
