...
import { extractJokerxArchive } from '../../../../Joker/dist/extensions/archive.js'
...
try {
  const archivePath = join(temporary, 'presentation-studio.Jokerx')
  ...
  const extracted = await extractJokerxArchive(archivePath, extractedRoot)
  ...
  process.stdout.write('Packed Joker PPT extracted, imported, and activated successfully.\n')
} finally {
