...
This is the exceptional, high-risk alternative to a stable Rcode View. Install it
...
`window.RcodeGui`, React object, account secret, runtime token, or another
extension's bridge. The only bridge is `window.RcodeHost`: this example reads its
...
host layout are unsupported compatibility dependencies: Rcode may change them in
