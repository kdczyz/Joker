...
This is the exceptional, high-risk alternative to a stable Joker View. Install it
...
`window.JokerGui`, React object, account secret, runtime token, or another
extension's bridge. The only bridge is `window.JokerHost`: this example reads its
...
host layout are unsupported compatibility dependencies: Joker may change them in
