...
import { RcodeLocalAudioAnalysisBroker } from '../src/host/Rcode-audio-analysis-broker.js'
import {
...
const descriptor: DenoiseMetadataAdapterDescriptor = {
  adapterId: 'Rcode.fixture.denoise-metadata',
...
describe('Host denoise metadata orchestration', () => {
  it('negotiates the current public Rcode Broker honestly unavailable', async () => {
