 ...
 *
 * Rcode owns durable native execution, the generic priority/concurrency gate,
...
export class DerivedMediaService {
  ...
  private async requestRecord(
    ...
    const request: DerivedRequest = {
      ...
      producer: { id: `Rcode-video-editor.${input.kind}`, version: this.context.extension.version },
