import type { GeneratedArtifact, JobSnapshot, MediaCapabilityFeature } from '@Rcode/extension-api'
  ...
  return <Panel title={messages.interchangeTitle}>
    ...
    {preview && <section className="interchange-import-preview" aria-label={messages.interchangeImportPreviewTitle}>
      <div className="interchange-heading">
        ...
        <span className="job-state">{preview.fidelity === 'Rcode-metadata'
          ? messages.interchangeFidelityRcode
      ...
      <dl className="interchange-metrics">
        ...
        <div><dt>{messages.interchangeFidelity}</dt><dd>{preview.fidelity === 'Rcode-metadata'
          ? messages.interchangeFidelityRcode
...
function LossManifestView({ manifest, messages }: {
  ...
  return <details className="interchange-loss" open={!manifest.portableLossless || !manifest.RcodeRoundTripLossless}>
    ...
    <p className={manifest.RcodeRoundTripLossless ? 'package-complete' : 'package-incomplete'}>
      {manifest.RcodeRoundTripLossless ? messages.interchangeRoundTripLossless : messages.interchangeRoundTripLossy}
    </p>
