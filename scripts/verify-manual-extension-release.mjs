...
import { verifyVideoEditorArchive } from './pack-Joker-video-editor.mjs'
...
async function main() {
  ...
  const directory = await mkdtemp(join(tmpdir(), 'Joker-manual-extension-release-'))
  try {
    ...
    process.stdout.write(
      ...
      `Joker Video Editor sha256 ${result.extension.sha256}\n`
    )
  } finally {
