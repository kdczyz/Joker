...
const report = await runReplaySuite(suite, {
  ...
  token: process.env.JOKER_RUNTIME_TOKEN,
...
function parseArgs(args: string[]): CliOptions {
  const options: CliOptions = {
    baseUrl: process.env.JOKER_RUNTIME_URL ?? DEFAULT_RUNTIME_URL,
...
function printUsage(): void {
  console.log('Usage:')
  console.log('  npm --prefix Joker run benchmark:replay -- --suite <file> [options]')
  console.log('')
  console.log('Options:')
  console.log(`  --base-url <url>          Joker runtime URL (or JOKER_RUNTIME_URL, default ${DEFAULT_RUNTIME_URL})`)
  ...
  console.log('')
  console.log('Authentication: set JOKER_RUNTIME_TOKEN; it is intentionally not accepted as a CLI flag.')
}
