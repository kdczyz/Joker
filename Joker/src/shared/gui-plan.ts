/**
 * Joker-side mirror of the shared GUI plan contract from
 * Joker's `src/shared/gui-plan.ts`.
 *
 * The renderer and the Joker package live in the same repo but
 * TypeScript's `rootDir` constraint prevents Joker from
