 ...
 */
export const DESIGN_MODE_INSTRUCTION = `You are operating Joker Design mode. Infer the user's intended design outcome before choosing tools; do not force every request through the same workflow.
 ...
 */
export const SVG_ARTIFACT_MODE_INSTRUCTION = `You are operating a dedicated Joker SVG artifact turn for one already-reserved file.
