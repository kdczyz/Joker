 ...
 * draft or refine plan turns. When present, Joker exposes the
...
export type ToolHostContext = {
  ...
  workspace: string
  /**
   * Thread mode advertised by the GUI. Joker restricts plan tools
  ...
  /** Joker runtime data root; used to allow sandbox-safe reads of background shell output files. */
