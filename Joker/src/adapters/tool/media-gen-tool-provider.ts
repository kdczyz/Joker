...
import type { JokerCapabilitiesConfig } from '../../contracts/capabilities.js'
...
export function buildSpeechGenToolProviders(
  config: JokerCapabilitiesConfig['speechGen'] | undefined,
...
export function buildMusicGenToolProviders(
  config: JokerCapabilitiesConfig['musicGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
...
export function buildVideoGenToolProviders(
  config: JokerCapabilitiesConfig['videoGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
