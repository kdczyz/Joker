...
export class ExtensionMediaProcessService {
  ...
  async audioAnalysisCapabilities(
    ...
    return {
      ...
      // produced by Joker's deterministic bounded onset/autocorrelation
   ...
   * bounds only; executable arguments and the resolved path stay inside Joker.
   */
   ...
   * evidence inside Joker. FFmpeg never chooses the algorithm and extensions
   ...
   * vector. No frame bytes or local locations leave Joker.
   */
