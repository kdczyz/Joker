...
function safeProvenanceMetadata(
  ...
  if (value.interchangeAdapterId === 'Joker.otio-json') {
  ...
  if (typeof value.JokerRoundTripLossless === 'boolean') metadata.JokerRoundTripLossless = value.JokerRoundTripLossless
