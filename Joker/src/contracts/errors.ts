...
/**
 * Structured API error codes returned by every Joker HTTP/SSE endpoint.
 *
 * The error contract mirrors what Joker diagnostics can render:
 ...
 */
export const JokerErrorCode = z.enum([
  'validation_error',
  'unauthorized',
  'forbidden',
  'not_found',
...
export type JokerErrorCode = z.infer<typeof JokerErrorCode>
...
export const JokerErrorBody = z.object({
  code: JokerErrorCode,
  message: z.string(),
  details: z.unknown().optional()
})
export type JokerErrorBody = z.infer<typeof JokerErrorBody>
