...
import { JokerCapabilitiesConfig } from './capabilities.js'
import { HooksConfigSchema } from '../hooks/hook-config.js'

const RuntimeConfigApplyServeConfig = JokerServeConfigSchema.omit({
  host: true,
  port: true,
  dataDir: true,
  runtimeToken: true,
...
export const RuntimeConfigApplyRequest = z
  .object({
    ...
    capabilities: JokerCapabilitiesConfig.optional(),
