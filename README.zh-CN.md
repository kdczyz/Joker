...
| **Android 客户端** | `Joker_apk/` | `npm run mobile:dev` | `npm run mobile:build` / `npm run mobile:apk` |
...
详细 API、部署方式与安全设计见 [`Fwq/README.md`](Fwq/README.md)；Android 能力与构建说明见 [`Joker_apk/README.md`](Joker_apk/README.md)。
